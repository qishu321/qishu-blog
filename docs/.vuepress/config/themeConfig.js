...
module.exports = {
  ...
  repo: "qishu321/qishu-blog", // 导航栏右侧生成Github链接
  ...
  author: {
    ...
    name: "七书", // 必需
    link: "https://github.com/qishu321", // 可选的
  },
  social: {
    // 社交图标，显示于博主信息栏和页脚栏
    ...
    icons: [
      {
        ...
        title: "GitHub",
        link: "https://github.com/qishu321",
      },
      // {
  ...
  footer: {
    ...
    copyrightInfo:
      'qishu | <a href="https://github.com/qishu321/qishu-blog/blob/main/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
  },
};
